#shweta-> acc no = 10 password = trial
#jagjeet-> acc no = 14 password = singh
#kaarnik-> acc no = 16 password = jamwal
#jeevanjot-> acc no = 17 password =hello
...
class Bank:
    def __init__(self,root):
        self.conn = sqlite3.connect("t.db", timeout=100)
        self.login = False
        self.root = root
        self.header = Label(self.root,text="PATIALA BANK",bg="#50A8B0",fg="white",font=("arial",20,"bold"))
